     ...
     <title>Outek</title>
      ...
      <div id="contact" class="contact">
         <div class="container">
            <div class="row">
               <div class="col-md-6">
                   <form id="request" class="main_form" action="https://formsubmit.co/juandavidome320@gmail.com" method="post">
                     <div class="row">
                        <div class="col-md-12 ">
                           <h3>Contact Us</h3>
                        </div>
                        ...
                        <div class="col-md-12">
                           <input class="contactus" placeholder="Correo" type="type" name="Correo">                          
                        </div>
                        <div class="col-md-12">
                           <input class="contactusmess" placeholder="Mensaje" type="type" Message="Mensaje">
                        </div>
                        <div class="col-md-12">
