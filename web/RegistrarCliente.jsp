<%-- 
    ...
    Created on : 19/03/2023, 03:57:24 PM
    Author     : juand
--%>
...
<body class="main-layout">
      ...
      <br>
            ...
            <form  class="row g-3 needs-validation" novalidate align="center" method="post" action="UsuarioControlador">
                ...
                <form action="UsuarioControlador" class="needs-validation" novalidate>
                <br>
                ...
                <div class="form-group">
                    <div class="row">
                        <div class="col-md-6" >
                            <input type="text" class="form-control" name="usuNombre" placeholder="Nombre" required>
                        ...
                        <div class="col-md-6" >
                            <input type="text" class="form-control" name="usuApellido" placeholder="Apellidos" required>
                            <div class="invalid-feedback">
                                Ingrese su apellido
                            </div>
                ...
                <div class="form-group" >
                    <input type="number" class="form-control" name="usuTelefono" placeholder="Telefono" required>
                    <div class="invalid-feedback">
                ...
                <div class="form-group" >
                    <input type="email" class="form-control" name="usuCorreo" placeholder="Correo Electronico" required>
                    <div class="invalid-feedback">
                ...
                <div class="form-group" >
                    <input type="text" class="form-control" name="usuDireccion" placeholder="Direccion" required>
                    <div class="invalid-feedback">
