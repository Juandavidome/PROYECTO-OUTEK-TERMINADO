<%-- 
    Document   : PersonalDeVentas
    Created on : 25/03/2023, 11:45:31 AM
    Author     : juand
--%>
...
<html>
      ...
      <!-- site metas --> 
     <title>Personal De Ventas</title>
                  ...
                  <div class="col-xl-3 col-lg-3 col-md-3 col-sm-3 col logo_section">
                     <div class="full">
                        <div class="center-desk">
                           <div class="logo">
                              <a href="PersonalDeVentas.jsp"><img src="images/OUTEK ACTUAL (1) (1).png" alt="#" /></a>
                           </div>
                        </div>
                     </div>
                  </div>
            ...
            <div class="carousel-inner">
               <div class="carousel-item active">
                  <div class="container">
                     <div class="carousel-caption">
                        <div class="text-bg">
                           <h1> <span class="blu">BIENVENIDO A <br></span>TECHNOLOGY CHEK-OUT PERSONAL DE VENTAS</h1>
               ...
               <div class="carousel-item">
                  <div class="container">
                     <div class="carousel-caption">
                        <div class="text-bg">
                           <h1> <span class="blu">TE AGRADECEMOS<br></span>POR LO QUE HAS CONSTRUIDO</h1>
               ...
               <div class="carousel-item">
                  <div class="container">
                     <div class="carousel-caption">
                        <div class="text-bg">
                           <h1> <span class="blu">JUNTOS POR UNA<br></span>BUENA EMPRESA</h1>
